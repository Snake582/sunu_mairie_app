...
export default function OccupationScreen() {
	...
	const pickImage = async (type: "photo" | "piece") => {
	...
	return (
		...
		>
			<View style={styles.container}>
				<StatusBar backgroundColor="#0E693D" barStyle="light-content" />

				<View style={styles.header}>
					<Text style={styles.headerTitle}>Autorisation d'occupation</Text>
				...
				>
					...
					<Text style={styles.sectionTitle}>Informations de l'occupation</Text>
					...
					<Text style={styles.sectionTitle}>Photo ou plan du lieu</Text>
