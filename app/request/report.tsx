...
export default function ReportScreen() {
  ...
  const handleSubmit = async () => {
    if (!typeProbleme || !adresse || !telephone || !description) {
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Aidez-nous à améliorer votre commune en signalant les incidents rencontrés.
          </Text>
        </View>

        {/* PHOTO */}
        <View style={styles.section}>
          <Text style={styles.label}>Photo du problème</Text>
          ...
          <TouchableOpacity style={styles.imagePicker} onPress={handlePickImage} activeOpacity={0.8}>
            {image ? (
              ...
              <View style={styles.imageEmpty}>
                ...
                <Text style={styles.imageSubText}>Prenez ou sélectionnez une image du problème</Text>
              </View>
            )}
          </TouchableOpacity>

          <TouchableOpacity style={styles.cameraButton} onPress={handleTakePhoto}>
            <IconSymbol name="camera-alt" size={20} color="#FFF" />
        ...
        <View style={styles.form}>
          ...
          {location && (
            <View style={styles.locationCard}>
              <IconSymbol name="location-on" size={20} color="#0E693D" />

              <Text style={styles.locationText}>Position détectée</Text>
            </View>
          )}

          <TouchableOpacity style={styles.locationButton} onPress={getCurrentLocation}>
            <IconSymbol name="my-location" size={20} color="#FFF" />
          ...
          <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
            <IconSymbol name="campaign" size={22} color="#FFF" />
