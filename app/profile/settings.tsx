	...
	return (
		<ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
			<View style={styles.header}>
				<IconSymbol name="settings" size={42} color="#FFF" />

				<Text style={styles.headerTitle}>Paramètres</Text>

				<Text style={styles.headerSubtitle}>Configurez votre expérience</Text>
			</View>
			...
			<View style={styles.section}>
				...
				<SettingItem
					...
					right={<IconSymbol name="chevron-right" size={24} color="#94A3B8" />}
				/>
				...
				<SettingItem
					...
					onPress={() => Alert.alert("Sunu Mairie", "Version 1.0.0")}
					right={<IconSymbol name="chevron-right" size={24} color="#94A3B8" />}
				/>
			</View>
